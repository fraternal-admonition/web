...
export default function SignUpPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[#F9F9F7] flex items-center justify-center p-4 pt-32">
        <div className="max-w-md w-full bg-white border border-[#E5E5E0] rounded-lg p-8 shadow-lg text-center">
          <div className="mb-6">
            ...
            <h2 className="text-2xl font-serif text-[#222] mb-2">
              Check Your Email!
            </h2>
          ...
          <div className="bg-[#F9F9F7] rounded-lg p-4 mb-6">
            <p className="text-sm text-[#666]">
              ...
              <button
                ...
                className="text-[#004D40] underline hover:text-[#00695C]"
              >
          ...
          <Link
            href="/"
            className="text-[#004D40] underline hover:text-[#00695C] text-sm"
          >
            ← Back to Home
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#F9F9F7] flex items-center justify-center p-4 pt-32 pb-20">
      <div className="max-w-md w-full bg-white border border-[#E5E5E0] rounded-lg p-8 shadow-lg">
        {/* Logo/Header */}
        <div className="text-center mb-6">
          <Link href="/" className="inline-block">
            <h1 className="text-3xl font-serif text-[#222] mb-2">
              Fraternal <span className="text-[#C19A43]">Admonition</span>
            </h1>
          </Link>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-white text-[#666]">
        ...
        <div className="mt-6 pt-4 border-t border-[#E5E5E0] text-center">
          <Link
            href="/"
            className="text-sm text-[#666] hover:text-[#004D40] transition-colors inline-flex items-center gap-1"
          >
            <svg
              className="w-4 h-4"
              fill="none"
